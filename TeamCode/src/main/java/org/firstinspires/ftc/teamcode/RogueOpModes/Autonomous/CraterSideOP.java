...
public class CraterSideOP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encodedDrive(new Velocity(0.0, 6.0, 0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.RADIANS), -3, DistanceUnit.INCH);
        encodedDrive(new Velocity(6.0, 0.0, 0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.RADIANS), 3, DistanceUnit.INCH);
        encodedDrive(new Velocity(0.0, 6.0, 0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.RADIANS), 3, DistanceUnit.INCH);
        encodedDrive(new Velocity(9.0, 0.0,0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.DEGREES), 21 - 11.25, DistanceUnit.INCH);


        sleep(1500);

        if (tfod.goldMineralInView()) {
            encodedDrive(new Velocity(9.0, 0.0, 0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.DEGREES), 20, DistanceUnit.INCH);
        ...
        switch (sampleState) {
            case CENTER:
                ...
                //encodedTurn(new Velocity(0.0,0.0,45.0, DistanceUnit.INCH, UnnormalizedAngleUnit.DEGREES), 90, UnnormalizedAngleUnit.DEGREES);
                encodedDrive(new Velocity(9.0, 0.0, 0.0, DistanceUnit.INCH, UnnormalizedAngleUnit.DEGREES), 17, DistanceUnit.INCH);
                break;
            case LEFT:
