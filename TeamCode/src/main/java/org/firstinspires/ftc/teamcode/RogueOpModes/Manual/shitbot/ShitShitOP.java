...
@TeleOp(name = "Rogue OP: Normal", group = "Testing")
public class ShitShitOP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (((DcMotorImplEx) FL).getVelocity(AngleUnit.RADIANS) > highestVelocity) highestVelocity = ((DcMotorImplEx) FL).getVelocity(AngleUnit.RADIANS);

            telemetry.addData("Speed switch: ", (!active)? "\"I'M FAST AS FRICK BOIIIII\" - Keemstar, 2015"  : "OH LAWD HE COMIN");
            telemetry.addData("Current Motor Velocity: ", ((DcMotorImplEx) FL).getVelocity(AngleUnit.RADIANS));
            telemetry.addData("Highest Motor Velocity: ", highestVelocity);
